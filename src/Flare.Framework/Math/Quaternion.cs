    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public static Quaternion Slerp(Quaternion q1, Quaternion q2, float t)
        {
            ...
            if (cos < 1.0f - 1e-3f)
            {
                ...
                float invSin = 1.0f / (float)(System.Math.Sqrt(1.0f - cos * cos));
                c0 = (float)System.Math.Sin((1.0f - t) * angle) * invSin;
                c1 = (float)System.Math.Sin(t * angle) * invSin;
            }
            else
            {
        ...
        public static Quaternion FromAxisAngle(Vector3 Axis, float Angle)
        {
            ...
            return new Quaternion(new Vector4(Axis.Normalize() * (float)System.Math.Sin(Angle * 0.5f), (float)System.Math.Cos(Angle * 0.5f)));
        }
